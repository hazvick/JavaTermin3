...
/*
    ...
    Known issues:
        - När man fått 3 irad, kan man fortsätta klicka på de oklickade knapparna och få poäng
        - Mediaplayer inte funktionell (nullpointer-err, förmodar path error)
 */

//controllern
public class Controller implements Initializable {

    //knapparna som ersätts med spelarinput (X/O)
    @FXML
    ...
    //variabler för score och turn
    private int playerTurn = 0;
    private int playerOneScore = 0;
    private int playerTwoScore = 0;

    //implementering av ljud via MediaPlayer - inte funktionellt ännu (nullpointer-err)
    MediaPlayer mediaPlayer;
    @FXML
    void play(MouseEvent event) {
        String fileName = "file:/image/Song.mp3";
